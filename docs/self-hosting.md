...
```bash
git clone --branch v0.1.2 --depth 1 https://github.com/openconvo/openconvo
cd openconvo
...
The guided installer pulls the exact `ghcr.io/openconvo/openconvo:0.1.2`
...
```bash
docker pull ghcr.io/openconvo/openconvo:0.1.2
docker run --rm ghcr.io/openconvo/openconvo:0.1.2 version
gh attestation verify oci://ghcr.io/openconvo/openconvo:0.1.2 -R openconvo/openconvo
```
