...
```bash
git clone --branch v0.1.3 --depth 1 https://github.com/openconvo/openconvo
cd openconvo
...
The guided installer pulls the exact `ghcr.io/openconvo/openconvo:0.1.3`
...
```bash
docker pull ghcr.io/openconvo/openconvo:0.1.3
docker run --rm ghcr.io/openconvo/openconvo:0.1.3 version
gh attestation verify oci://ghcr.io/openconvo/openconvo:0.1.3 -R openconvo/openconvo
```
